  ...
  return createPortal(
    ...
    >
      <motion.div
        ...
        className="min-w-[140px] overflow-hidden rounded-lg bg-[color:var(--chart-tooltip-background)] text-[color:var(--chart-tooltip-foreground)] shadow-lg backdrop-blur-md"
